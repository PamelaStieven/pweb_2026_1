...
if (!empty($_POST)) {
    ...
    try {
        ...
        if (empty($errors)) {
            ...
            $db->store($_POST);
            $success = "Registro Salvo com sucesso! Redirecionando para o login...";
...
<div class="row">
    ...
    <form action="registrar.php" method="post">
        ...
        <div class="mt-2">
            <button type="submit" class="btn btn-success">Salvar</button>Já tem conta?
            <a href="./UsuarioList.php" class="btn btn-primary"> Faça login aqui</a>
        </div>
